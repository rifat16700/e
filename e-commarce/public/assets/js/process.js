...
var alertMessage =
  ...
  (function ($) {
    var $html = $(
      '<div class="alert alert-icon content d-none" role="alert">' +
...
function plugin_editor(selector, settings) {
  ...
  var _settings = {
    ...
    image_advtab: true,
    toolbar1:
      "fontsizeselect | forecolor backcolor | code table bold italic | alignleft aligncenter alignright alignjustify | bullist numlist | link image | preview emoticons",
    // file_browser_callback: elFinderBrowser,
    images_upload_handler: function (blobInfo, success, failure, progress) {
      getPathMediaByelFinderBrowser(blobInfo, success, failure, progress);
    },
  };
...
//   var defaultBackgroundColor = "#333333"; // Dark background color
//   var defaultTextColor = "#ffffff"; // Default text color
...
//     image_advtab: true,
//     toolbar1:
//       "forecolor backcolor | code bold italic | alignleft aligncenter alignright alignjustify | bullist numlist | link image media | print preview emoticons",
//     // file_browser_callback: elFinderBrowser,
//       images_upload_handler: function (blobInfo, success, failure, progress) {
//       getPathMediaByelFinderBrowser(blobInfo, success, failure, progress);
//     },
...
//       editor.getBody().style.color = settings.textColor || defaultTextColor;
//     },
//   };
...
function getPathMediaByelFinderBrowser(blobInfo, success, failure, progress) {
...
function elFinderBrowser(field_name, url, type, win) {
  tinymce.activeEditor.windowManager.open(
    {
      file: PATH + "public/uploads/user", // use an absolute path!
      title: "File manager",
      width: 900,
      height: 450,
      resizable: "yes",
...
function copyToClipBoard(
  ...
  if (typeof params != "undefined") {
    ...
    if (navigator.clipboard && navigator.clipboard.writeText) {
      navigator.clipboard.writeText(copyText.val() || copyText.text());
    } else {
